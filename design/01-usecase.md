...
> 출처: `ai-place-srs-v1_0.md` §1.3.2 · §1.3.3 · §4.1
...
> **이 유스케이스가 가드레일 지표를 만든다.** 화면이 "가능"으로 표시했는데 주문이 거부되면 그 한 번으로 화면 전체의 신뢰가 무너진다. 일간 거부율 0.1%를 넘으면 자동 알람과 롤백이 걸린다 (SRS §6.4.2).
...
| 유스케이스 | 요구사항 건수 | 인수 조건 |
|---|:---:|---|
| UC-01 | 5 | SRS §5.2 F1-02 #1 ~ #6 |
| UC-02 | 10 | SRS §5.2 F1-03 #1 ~ #3, #7, #11 |
| UC-03 | 2 | SRS §5.2 F1-03 #4, #8, #10 |
| UC-04 | 11 | SRS §5.2 F1-01 #1 ~ #4, F1-04 #1 ~ #10 |
| UC-05 | 5 | SRS §5.2 F1-05 #1 ~ #5 |
| UC-06 | 6 | SRS §5.2 F1-06 #1 ~ #6 |
| UC-07 | 3 | SRS §5.2 F1-03 #5, #6 |
| UC-08 | 4 | SRS §5.2 F2-01 #1 ~ #4, F2-03 #7, #8 |
| UC-09 | 21 | SRS §5.2 F2-03 #1 ~ #9, F2-04 #1 ~ #8 |
| UC-10 | 5 | SRS §5.2 F2-05 #1 ~ #4 |
| UC-11 | 4 | SRS §5.2 F2-06 #1 ~ #4 |
| UC-12 | 2 | SRS §5.2 F1-03 #3, #4, #9 |
| UC-13 | 2 | SRS §5.2 F1-01 #5, F1-04 #4 |
| UC-14 | 1 | SRS §5.2 F2-04 #6 |
